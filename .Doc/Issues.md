...
- Status: [→] Testing (базовая логика работает, добавлено автоматическое сдвижение)
...
- Latest Commits:
  ...
  - ✓ 6bf7328 - Добавлено сдвижение B, C, D... при вставке X в середину
- Features Working:
  - ✓ Вставка в начало цепи (X перед A): OUTPUT X совпадает с INPUT A
  - ✓ Вставка в середину цепи (X между A и B):
    - INPUT X = OUTPUT A
    - OUTPUT X = INPUT B
    - B, C, D... сдвигаются вниз на реальное смещение B
