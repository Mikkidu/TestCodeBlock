...
- Features Implemented:
  ...
  - ✓ Автоматическое раздвижение: при вставке X между A и B → B и C сдвигаются вниз
    - Расстояние сдвига = высота блока + 10px padding
    - Визуальное расположение совпадает с логическим порядком выполнения
