...
namespace RobotProgramming.Execution
{
    public class CommandExecutor : MonoBehaviour, ICommandExecutor
    {
        ...
        /// </summary>
        public IPromise ExecuteProgramFromBlock(RobotProgramming.UI.BlockUIBase startBlock, IRobotController robot)
        {
            if (IsRunning)
            {
                return Deferred.Rejected(new Exception("Executor already running"));
        ...
        /// </summary>
        private int CountCommandsFromBlock(RobotProgramming.UI.BlockUIBase startBlock)
        {
            int count = 0;
            RobotProgramming.UI.BlockUIBase current = startBlock;
        ...
        /// </summary>
        private IPromise ExecuteBlockChain(RobotProgramming.UI.BlockUIBase block, IRobotController robot, ExecutionContext context)
        {
            if (block == null)
            {
                // End of chain
            ...
            pauseCheck
                ...
                .Done(() =>
                {
                    ...
                    RobotProgramming.UI.BlockUIBase nextBlock = block.GetNextBlock();
